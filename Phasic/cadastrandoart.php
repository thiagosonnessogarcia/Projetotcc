<html>
	...
	<head>
		<title>Cadastrando Artista</title>
	</head>
<body>
<?php
$host = "localhost";
...
<?php
	...
	$sql = mysql_query("INSERT INTO artista(nick, nome, sobrenome, email, senha, confirmarsenha, cpf, rg, sexo, datadenascimento, ip, data)
	...
	header("Location: loginart-home.php");
?>
