...
<html>
	<head>
	<meta charset="utf-8">
		<title>Autenticando Artista</title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css" rel="stylesheet">
	<script type="text/javascript">
	function loginsuccessfully() {
		setTimeout("window.location='posloginart/production/posartindex.php'", 3000);
	}
	
	function loginfailed(){
		setTimeout("window.location='loginart-home.php'", 5000);
	}
	</script>
...
$sql = mysqli_query($conexao,"SELECT * FROM artista WHERE email = '$email' and senha = '$senha'") or die (mysql_error());
...
if($row > 0){
    ...
    $_SESSION['nick'] = $res['nick'];
        echo "<center><h1>Login realizado com sucesso!!!</center></h1>";
    echo "<center><h2>Você será redirecionado para sua página</center></h2>";
    echo "<script>loginsuccessfully()</script>";
} else {
    echo "<center><h1>Nome de usuário ou senha inválidos!!!</center></h1>";
    echo "<center><h2>aguarde um instante para tentar novamente</center></h2>";
